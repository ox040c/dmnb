...
{
       0,    66,    66,    67,    71,    72,    73,    78,    80,    85,
      86,    90,    91,    92,    93,    94,    98,    99,   103,   104,
     108,   109,   110,   114
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "STRING", "OP", "ADD",
  "AND", "CHAR", "CREATE", "DATABASE", "DATABASES", "DELETE", "DROP",
  "EXIT", "FLOAT_type", "FROM", "INDEX", "INSERT", "INT_type", "KEY",
  "NOT", "ON", "PRIMARY", "SELECT", "TABLE", "VALUES", "UNIQUE", "WHERE",
  "';'", "'('", "')'", "','", "'*'", "$accept", "list", "statement",
  "create_stmt", "attr_list", "attr", "select_stmt", "condition_list",
  "expr", "drop_stmt", YY_NULLPTR
};
#endif
...
{
      -8,   -13,   -23,   -22,     0,   -24,    11,    16,    -7,    17,
      -6,     9,    -3,   -24,   -24,     5,    -2,   -24,   -24,   -24,
      25,   -24,    26,    -4,     3,     2,    -5,    13,   -14,     7,
      31,    32,     8,   -24,   -24,    10,   -24,    -4,   -24,    34,
      30,   -24,    12,    39,    38,     7,     4,    31,   -24,    14,
      15,   -24,   -24,   -24,   -24,   -24,   -24
};
...
{
       0,     0,     0,     0,     0,     2,     0,     0,     0,     0,
       0,     0,     0,     1,     3,     0,     0,     4,    23,     6,
       0,     5,     0,     0,    16,     0,     0,     0,     0,    10,
       0,     0,     0,    13,    12,     0,     7,     0,    14,     0,
      17,    18,     0,     0,     0,     9,     0,     0,     8,     0,
       0,    21,    22,    20,    19,    11,    15
};
...
{
     -24,   -24,    41,   -24,   -24,    18,   -24,   -24,     1,   -24
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     8,    28,    29,    12,    40,    41,    10
};
...
{
      13,    26,     1,     9,    32,     6,     2,    51,    52,    53,
       1,    33,    11,     7,     2,    34,    15,     3,    36,    37,
      27,    16,    18,    17,    19,     3,    20,    21,    22,    23,
      24,    25,    30,    31,    35,    38,    39,    42,    47,    43,
      46,    44,    49,    50,    48,    14,    55,    56,    54,     0,
       0,     0,     0,     0,     0,    45
};

static const yytype_int8 yycheck[] =
{
       0,     5,    10,    26,     9,    18,    14,     3,     4,     5,
      10,    16,    34,    26,    14,    20,     5,    25,    32,    33,
      24,     5,     5,    30,    30,    25,    17,    30,    23,    31,
       5,     5,    29,    31,    21,    28,     5,     5,     8,    31,
       6,    31,     3,     5,    32,     4,    32,    32,    47,    -1,
      -1,    -1,    -1,    -1,    -1,    37
};
...
{
       0,    10,    14,    25,    36,    37,    18,    26,    38,    26,
      44,    34,    41,     0,    37,     5,     5,    30,     5,    30,
      17,    30,    23,    31,     5,     5,     5,    24,    39,    40,
      29,    31,     9,    16,    20,    21,    32,    33,    28,     5,
      42,    43,     5,    31,    31,    40,     6,     8,    32,     3,
       5,     3,     4,     5,    43,    32,    32
};
...
#line 81 "parse.y" /* yacc.c:1646  */
    { cout << "craete index" << (yyvsp[-5].sval) << (yyvsp[-3].sval) << (yyvsp[-1].sval); }
